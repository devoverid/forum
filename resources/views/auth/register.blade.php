                    ...
                    <div class="p-8">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-5">
                                ...
                                <input value="{{ old('name') }}" type="text" name="name" class="block w-full p-3 rounded bg-gray-100 border-transparent focus:outline-none transition duration-200 focus:bg-gray-200 focus:bg-gray-300 @error('name') border-4 border-red-300 @enderror" required autocomplete="name" autofocus>
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input value="{{ old('email') }}" type="email" name="email" class="block w-full p-3 rounded bg-gray-100 border-transparent focus:outline-none transition duration-200 focus:bg-gray-200 focus:bg-gray-300 @error('email') border-4 border-red-300 @enderror" required autocomplete="email" autofocus>
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input type="password" name="password" class="block w-full p-3 rounded bg-gray-100 border-transparent focus:outline-none transition duration-200 focus:bg-gray-200 focus:bg-gray-300 @error('password') border-4 border-red-300 @enderror" required autocomplete="new-password">
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <input type="password" name="password_confirmation" class="block w-full p-3 rounded bg-gray-100 border-transparent focus:outline-none transition duration-200 focus:bg-gray-200 focus:bg-gray-300 @error('password_confirmation') border-4 border-red-300 @enderror" required autocomplete="new-password">
                            </div>
                            ...
                            <div>
                                ...
                                <a href="{{ route('auth.oauth', ['facebook']) }}" class="block text-center w-full p-3 mt-4 bg-blue-500 text-white rounded shadow hover:bg-blue-600">
                                    ...
                                    <span class="hidden md:inline-block">Register with Facebook</span>
